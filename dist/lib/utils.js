...
exports.getTierFromPlan = getTierFromPlan;
...
async function getActivityLogs(page = 1, limit = 20, logType = 'all') {
...
async function getActivityStats() {
    ...
    const { data: todayLogs } = await supabase_1.supabase
        .from('activity_logs')
    ...
    const { count: totalLogs } = await supabase_1.supabase
        .from('activity_logs')
