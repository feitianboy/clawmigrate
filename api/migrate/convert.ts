...
function normalizeData(data: any, sourcePlatform: string): NormalizedConfig {
  return {
...
function convertToTarget(data: NormalizedConfig, targetPlatform: string, targetInfo: any): any {
...
function toClaudeFormat(data: NormalizedConfig) {
  return {
    format: 'claude',
...
function toKimiFormat(data: NormalizedConfig) {
  return {
    format: 'kimi',
    label: 'Kimi 助手配置',
...
function toGeminiFormat(data: NormalizedConfig) {
  return {
    format: 'gemini',
    label: 'Gemini Gem 配置',
...
function toCozeFormat(data: NormalizedConfig) {
  return {
    format: 'coze',
    label: 'Coze Bot 配置',
...
function toDeepSeekFormat(data: NormalizedConfig) {
  return {
    format: 'deepseek',
    label: 'DeepSeek 助手配置',
...
function toGenericFormat(data: NormalizedConfig, targetName: string) {
  return {
    format: 'generic',
    label: `${targetName} 配置`,
...
function calculateStats(normalized: NormalizedConfig, converted: any) {
